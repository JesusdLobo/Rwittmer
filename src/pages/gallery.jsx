  ...
  return (
    <>
      <Helmet>
        ...
        <title>Activities &#8211; Rolf Wittmer</title>
        ...
        <link rel='alternate' type='application/json' href='../../wp-json/wp/v2/pages/1491' />
        ...
        <link rel='shortlink' href='index.htm?p=1491' />
        <link
          rel='alternate' type='application/json+oembed'
          href='../../wp-json/oembed/1.0/embed-38?url=https%3A%2F%2Frwittmercom.delabridge.dev%2Fgallery%2Factivities%2F'
        />
        <link
          rel='alternate' type='text/xml+oembed'
          href='../../wp-json/oembed/1.0/embed-39?url=https%3A%2F%2Frwittmercom.delabridge.dev%2Fgallery%2Factivities%2F&#038;format=xml'
        />
      ...
      <main id='brx-content'>
        <section id='brxe-rmfskc' className='brxe-section rw_section--hero-gallery'>
          <div className='brxe-container'>
            <div className='brxe-div rw_container--1160 center--all'>
              <span id='brxe-plnptv' className='brxe-heading text--primary'>
                <span style={{ fontWeight: 700 }}>Photos</span> and videos
              </span>
              <div id='brxe-ksgyrn' className='brxe-block bg--action text--left'>
                <div id='brxe-oqqvus' className='brxe-div width--full rw_grid text--white'>
                  <Link id='brxe-lrchpn' to='gallery/tip-top-fleet' className='brxe-div rw_aspect-ratio__square'>
                    <span className='brxe-heading'>Tip Top<br />
                      <span style={{ fontWeight: 300 }}>Fleet</span>
                    </span>
                  </Link>
                  <Link id='brxe-okrbcf' to='gallery/flora-and-fauna' className='brxe-div rw_aspect-ratio__square'>
                    <span className='brxe-heading'>Flora<br /><span style={{ fontWeight: 300 }}>and Fauna</span></span>
                  </Link>
                  <Link id='brxe-qshqth' to='gallery/the-wittmer-familys-story' className='brxe-div rw_aspect-ratio__square'>
                    <span className='brxe-heading'>The Wittmer<br />
                      <span style={{ fontWeight: 300 }}>Family&apos;s Story</span>
                    </span>
                  </Link>
                  <Link id='brxe-tsgdcc' to='gallery/activities' className='brxe-div rw_aspect-ratio__square'>
                    <span className='brxe-heading'>Activities</span>
                  </Link>
                </div>
              </div>
            </div>
