...
import useExternalLink from '../hooks/useExternalCss'
import useExternalScriptsBlock from '../hooks/useExternalScriptsBlock'
import { BRICKS, BRICKSDATA } from '../consts'
import { PlanningSlides } from '../components/planning'

export function Index () {
  /* useExternalLink({ url: 'public/wp-content/themes/bricks/assets/css/libs/splide.min.css' })
  useExternalScriptsBlock({ content: BRICKS })
  useExternalScripts({ url: 'public/wp-content/themes/bricks/assets/js/bricks.min.js' })
  useExternalScripts({ url: 'public/wp-content/themes/bricks/assets/js/libs/splide.min.js' }) */
  ...
  return (
    <>
      <Helmet>
        ...
        />
        <link
          rel='stylesheet' id='bricks-post-458-css'
          href='wp-content/uploads/bricks/css/post-458.min.css?ver=1689719965' media='all'
        />
        <link
        ...
        <link rel='stylesheet' href='wp-content/themes/bricks/assets/css/libs/splide.min.css' media='all' />

        <script src='wp-content/themes/bricks/assets/js/bricks.min.js' />

        <script src='wp-content/themes/bricks/assets/js/libs/splide.min.js' />
      </Helmet>
      ...
      <main id='brx-content'>
        <section id='brxe-btbjuh' className='brxe-section rw_section--hero'>
          <div className='brxe-container text--white rw_container--hero'>
            <div className='brxe-block rw_flex__grow'>
              ...
              <div id='brxe-hvuemr' className='brxe-block center--all'>
                <a className='brxe-button bricks-button' href='./contact-us/'>Book</a>
              </div>
            </div>
          </div>
        </section>
        ...
        <div id='brxe-ujmndk' className='brxe-container pad--xxl'>
          <div id='brxe-yjcnzf' className='brxe-div grid--2 rw_shadow text--white gap--s grid--l-1'>
            <Link id='brxe-wvmdmg' to='./next-departures/' className='brxe-div col-span--2'>
            ...
            <Link id='brxe-mlaghf' to='./last-minute-deals-and-special-promos/' className='brxe-div'>
            ...
            <Link id='brxe-fwaafm' to='./last-minute-deals-and-special-promos/' className='brxe-div'>
          ...
          <div className='brxe-container pad--xxl center--all'>
            <div id='brxe-ewmazn' className='brxe-block gap--xl'>
              <div id='brxe-xksxxe' className='brxe-div grid--3 grid--s-1'><a
                ...
                href='./wp-content/uploads/home-history-section-collage-01.jpg'
                data-pswp-src='./wp-content/uploads/home-history-section-collage-01.jpg'
                data-pswp-width='600' data-pswp-height='600' data-pswp-id='home-collage'
                                                                           ><img
                                                                             width='600'
                                                                             height='600'
                                                                             src='./wp-content/uploads/home-history-section-collage-01.jpg'
                                                                             className='css-filter size-full' alt='' decoding='async' loading='lazy'
                                                                             srcSet='./wp-content/uploads/home-history-section-collage-01.jpg 600w, ./wp-content/uploads/home-history-section-collage-01-540x540.jpg 540w, ./wp-content/uploads/home-history-section-collage-01-270x270.jpg 270w'
                                                                             sizes='(max-width: 600px) 100vw, 600px'
                                                                           />
                                                                           </a><a
                className='brxe-image rw_collage__single-image tag bricks-lightbox'
                href='./wp-content/uploads/home-history-section-collage-02.jpg'
                data-pswp-src='./wp-content/uploads/home-history-section-collage-02.jpg'
                data-pswp-width='600' data-pswp-height='600' data-pswp-id='home-collage'
                  ><img
                                                                                 width='600'
                                                                                 height='600'
                                                                                 src='./wp-content/uploads/home-history-section-collage-02.jpg'
                                                                                 className='css-filter size-full' alt='' decoding='async' loading='lazy'
                                                                                 srcSet='./wp-content/uploads/home-history-section-collage-02.jpg 600w, ./wp-content/uploads/home-history-section-collage-02-540x540.jpg 540w, ./wp-content/uploads/home-history-section-collage-02-270x270.jpg 270w'
                                                                                 sizes='(max-width: 600px) 100vw, 600px'
                                                                               />
                  </a><a
                                                                                 className='brxe-image rw_collage__single-image tag bricks-lightbox'
                                                                                 href='./wp-content/uploads/home-history-section-collage-03.jpg'
                                                                                 data-pswp-src='./wp-content/uploads/home-history-section-collage-03.jpg'
                                                                                 data-pswp-width='600' data-pswp-height='600' data-pswp-id='home-collage'
                                                                                   ><img
                        width='600'
                        height='600'
                        src='./wp-content/uploads/home-history-section-collage-03.jpg'
                        className='css-filter size-full' alt='' decoding='async' loading='lazy'
                        srcSet='./wp-content/uploads/home-history-section-collage-03.jpg 600w, ./wp-content/uploads/home-history-section-collage-03-540x540.jpg 540w, ./wp-content/uploads/home-history-section-collage-03-270x270.jpg 270w'
                        sizes='(max-width: 600px) 100vw, 600px'
                      />
                                                                                   </a><a
                        className='brxe-image rw_collage__single-image tag bricks-lightbox'
                        href='./wp-content/uploads/home-history-section-collage-04.jpg'
                        data-pswp-src='./wp-content/uploads/home-history-section-collage-04.jpg'
                        data-pswp-width='600' data-pswp-height='600' data-pswp-id='home-collage'
                          ><img
                                                                                         width='600'
                                                                                         height='600'
                                                                                         src='./wp-content/uploads/home-history-section-collage-04.jpg'
                                                                                         className='css-filter size-full' alt='' decoding='async' loading='lazy'
                                                                                         srcSet='./wp-content/uploads/home-history-section-collage-04.jpg 600w, ./wp-content/uploads/home-history-section-collage-04-540x540.jpg 540w, ./wp-content/uploads/home-history-section-collage-04-270x270.jpg 270w'
                                                                                         sizes='(max-width: 600px) 100vw, 600px'
                                                                                       />
                          </a><a
                                                                                         className='brxe-image rw_collage__single-image tag bricks-lightbox'
                                                                                         href='./wp-content/uploads/home-history-section-collage-05.jpg'
                                                                                         data-pswp-src='./wp-content/uploads/home-history-section-collage-05.jpg'
                                                                                         data-pswp-width='600' data-pswp-height='600' data-pswp-id='home-collage'
                                                                                           ><img
                                width='600'
                                height='600'
                                src='./wp-content/uploads/home-history-section-collage-05.jpg'
                                className='css-filter size-full' alt='' decoding='async' loading='lazy'
                                srcSet='./wp-content/uploads/home-history-section-collage-05.jpg 600w, ./wp-content/uploads/home-history-section-collage-05-540x540.jpg 540w, ./wp-content/uploads/home-history-section-collage-05-270x270.jpg 270w'
                                sizes='(max-width: 600px) 100vw, 600px'
                              />
                                                                                           </a><a
                                className='brxe-image rw_collage__single-image tag bricks-lightbox'
                                href='./wp-content/uploads/home-history-section-collage-06.jpg'
                                data-pswp-src='./wp-content/uploads/home-history-section-collage-06.jpg'
                                data-pswp-width='600' data-pswp-height='600' data-pswp-id='home-collage'
                                  ><img
                                                                                                 width='600'
                                                                                                 height='600'
                                                                                                 src='./wp-content/uploads/home-history-section-collage-06.jpg'
                                                                                                 className='css-filter size-full' alt='' decoding='async' loading='lazy'
                                                                                                 srcSet='./wp-content/uploads/home-history-section-collage-06.jpg 600w, ./wp-content/uploads/home-history-section-collage-06-540x540.jpg 540w, ./wp-content/uploads/home-history-section-collage-06-270x270.jpg 270w'
                                                                                                 sizes='(max-width: 600px) 100vw, 600px'
                                                                                               />
                                  </a>
              </div>
              <div className='brxe-div grid--1 center--all gap--m'>
                <div id='brxe-jdmejt' className='brxe-text-basic'>For reading the full story</div>
                <Link to='about-us' className='brxe-button rw_btn--outline-primary bricks-button'>Click Here</Link>
              </div>
            </div>
          </div>
        </section>
          ...
          <div id='brxe-gxnaft' className='brxe-container'>
            ...
            <form id='brxe-ojhsii' data-script-id='ojhsii' className='brxe-form' method='post' data-element-id='ojhsii'>
              <div className='form-group'>
                ...
                <input
                  id='form-field-0fccb3' name='form-field-519b44' aria-label='Email' type='email'
